...
internal object OceanBoss : BossInterface {
    override val name: String = "Leviathan, the Abyssal Tyrant"
    ...
    override val bossBar: BossBar =
        BossBar.bossBar(
            MM.deserialize("<bold><gradient:#1E90FF:#00008B>$name</gradient></bold>"),
            1.0f,
            BossBar.Color.BLUE,
    ...
    override fun spawn(location: Location): LivingEntity =
        (location.world.spawnEntity(location, entityType) as LivingEntity).apply {
            customName(MM.deserialize("<bold><gradient:#1E90FF:#00008B>$name</gradient></bold>"))
