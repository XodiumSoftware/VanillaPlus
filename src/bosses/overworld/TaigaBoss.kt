...
internal object TaigaBoss : BossInterface {
    override val name: String = "Bjorn, the Frost Sentinel"
    ...
    override val bossBar: BossBar =
        BossBar.bossBar(
            MM.deserialize("<bold><gradient:#00CED1:#4682B4>$name</gradient></bold>"),
            1.0f,
            BossBar.Color.BLUE,
    ...
    override fun spawn(location: Location): LivingEntity =
        (location.world.spawnEntity(location, entityType) as LivingEntity).apply {
            customName(MM.deserialize("<bold><gradient:#00CED1:#4682B4>$name</gradient></bold>"))
