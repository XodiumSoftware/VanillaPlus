...
internal object PlayerPDC {
    private val NICKNAME_KEY = NamespacedKey(VanillaPlus.instance, "nickname")
    private val SCOREBOARD_VISIBILITY_KEY = NamespacedKey(VanillaPlus.instance, "scoreboard_visibility")
