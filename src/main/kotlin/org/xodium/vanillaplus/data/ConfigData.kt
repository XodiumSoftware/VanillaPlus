 ...
 * @property signModule Configuration for the `SignModule`.
...
data class ConfigData(
    ...
    var signModule: SignModuleData = SignModuleData(),
...
/**
 * Data class representing the configuration for the `SignModule`.
 * @property enabled Indicates whether the module is enabled. Default is true.
 */
data class SignModuleData(
    var enabled: Boolean = true,
)
